...
if [ $# -lt 4 ]; then
    echo "Faltan argumentos. Uso: $0 <archivo_memoria> <carpeta_principal> <perfil_sistema> <carpeta a vol.py> <comandos_elegidos>"
    exit 1
fi
...
do
    echo "$(tput setaf 1)Extrayendo información de $comando_elegido $(tput setaf 4)"
